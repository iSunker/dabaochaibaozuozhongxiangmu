...
> ★★ **先看 `SUMMARY §26`（2026-09-17）—— 那是「跨会话待办真源」**：
> 旧会话（`79536301` / `cea0d519` / `97ecd174` / `1352dd2f` / `5e388a03`）**已清场**，
> 未完成任务**全部抽干到那一节**；本会话棋盘 11 条未完成、`#129` 的删除断点与续跑、
> `#58` 的切断点也都在那里。**下面的表是历史快照，别当成最新待办。**
